...
export function CustomNode({ data, id, selected }: NodeProps) {
  ...
  return (
    <>
      ...
      >
        <Handle type="source" position={Position.Top} id="top" className="w-3 h-3 !bg-gray-400 !z-10" />
        <Handle type="source" position={Position.Bottom} id="bottom" className="w-3 h-3 !bg-gray-400 !z-10" />

        <Handle type="target" position={Position.Top} id="top" className="w-3 h-3 !bg-gray-400 !z-10" />
        <Handle type="target" position={Position.Bottom} id="bottom" className="w-3 h-3 !bg-gray-400 !z-10" />
